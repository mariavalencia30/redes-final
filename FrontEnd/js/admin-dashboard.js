...
class PurchaseManager {
    ...
    static async registerPurchase(purchaseData) {
        try {
            ...
            const payload = {
                userId: parseInt(purchaseData.userId),
                vehicleId: parseInt(purchaseData.vehicleId),
                precioTotal: parseFloat(purchaseData.precioTotal),
                metodoPago: purchaseData.metodoPago || 'Tarjeta',
            ...
            if (purchaseData.visitaId) {
                payload.visitaId = parseInt(purchaseData.visitaId);
            }
